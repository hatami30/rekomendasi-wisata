...
<section class="wisata-detail">
    <div class="container">
        <div class="image-container text-center">
            <img src="{{ asset('storage/' . $wisata->gambar_wisata) }}" alt="Gambar" class="img-fluid rounded mx-auto d-block">
        </div>
            ...
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <img src="{{ asset('storage/user/wisata_photos/' . $image->image_path) }}" class="card-img-top" alt="Image">
                        </div>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="row mt-4">
            <div class="col-lg-8">
                ...
                <div class="dropdown" style="position: relative;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="ratingDropdown" style="position: absolute; max-height: 80px; overflow-y: auto; z-index: 1000;">
            ...
            <div class="col-lg-4 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="https://www.google.com/maps/search/?api=1&query={{ $wisata->latitude }},{{ $wisata->longitude }}" target="_blank" class="btn btn-primary">Lihat Lokasi
